...
const FOLD_SUMMARY_CORE = [
  ...
  '## What happened',
  '- [the work performed in this span, in order — one bullet per phase of 3-5 steps, each bullet citing its L<N>-<M> copied from the Span message index AND the reasoning behind the work: why this path, which alternatives were rejected and why]',
